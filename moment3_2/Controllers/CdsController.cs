...
namespace moment3_2.Controllers
{
    public class CdsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Released,ArtistId")] Cd cd)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Released,ArtistId")] Cd cd)
        {
            if (id != cd.Id)
            {
                return NotFound();
